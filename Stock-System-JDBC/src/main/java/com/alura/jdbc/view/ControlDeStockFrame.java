...
public class ControlDeStockFrame extends JFrame {
    ...
    private void configurarTablaDeContenido(Container container) {
        ...
        botonReporte.setBounds(190, 500, 100, 20);
    ...
    private void cargarTabla() {
        // Llama al método listar de productoController para obtener la lista de productos desde la base de datos
        var productos = this.productoController.listar();

        // Itera a través de la lista de productos y agrega cada producto como una nueva fila en el modelo de la tabla
